...
function homePage() {
  ...
  return `<section class="hero"><div class="hero-copy"><span class="eyebrow">${icon('sparkle',16)} 吃好喝好</span><h1>动动手指，<br>解决“随便吃”和“都可以”</h1></div><div class="hero-side"><div class="big-icon">${icon('chef',42)}</div><div><strong>${state.dishes.length} 道家常菜</strong><p>已经收入你家的菜单库，想吃什么直接去菜单里挑。</p></div></div></section>
